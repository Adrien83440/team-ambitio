...
(function () {
  ...
  function ensureCss() {
    ...
    s.textContent = [
      ...
      /* La fiche se prolonge avec la page, mais PAS le fil : une conversation
         de deux cents messages la rendrait interminable et repousserait le
         composeur hors de portée. Le plafond est simplement plus généreux sur
         grand écran, où la place ne manque pas. */
      '@media (min-width:980px){.wal-fil{max-height:min(52vh,420px)}}'
    ].join('');
