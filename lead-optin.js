...
// Décode un UTM percent-encodé reçu du webhook (ex: "3%29NEW-%C3%A9t%C3%A9"
// -> "3)NEW-été"). Certaines landing pages transmettent l'utm_campaign brut,
// non décodé. Décodage défensif : valeur déjà propre -> inchangée ; séquence %
// invalide (ex: "Promo 50%") -> conservée telle quelle, sans jamais planter.
...
module.exports = async (req, res) => {
  ...
  const tunnelLabel = type === 'business' ? 'VSL Business'
                    ...
                    : (typeRaw || type);
  const utm         = decodeUtm(String(utmRaw || tunnelLabel));
